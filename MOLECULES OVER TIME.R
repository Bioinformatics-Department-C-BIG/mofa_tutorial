...
fn_sel=1
ws<-get_weights(MOFAobject, views = 'RNA', factors=sel_factors[fn_sel])[[1]]
ws
...
ws_high<-ws[abs(ws)>quantile(ws, 0.996),]
...
warnings()
ggsave(paste0(outdir, '/trajectories/', sel_factors[fn_sel], '.jpeg'))
