...
#nf=c(2,4,6,18,22)
#nf=c(4,6)
#nf=get_factors_for_metric('NP3TOT_LOG')
nf=c(13,15,20,24,28)
nf=c(2,11, 23)
...
en_plots_all_proteins<-get_files(paste0(outdir_enrich, '/proteomics_t_plasma/ora/'))
en_plots_all_proteins_csf<-get_files(paste0(outdir_enrich, '/proteomics_t_csf/ora/'))
...
en_plots_all_proteins_gc<-get_files(paste0(outdir_enrich, '/proteomics_t_plasma/ora/'), type='gc')
en_plots_all_proteins_csf_gc<-get_files(paste0(outdir_enrich, '/proteomics_t_csf/ora/'), type='gc')
...
en_plots_all_proteins_emap<-get_files(paste0(outdir_enrich, '/proteomics_t_plasma/ora/'), type='_emap')
en_plots_all_proteins_csf_emap<-get_files(paste0(outdir_enrich, '/proteomics_t_csf/ora/'), type='_emap')
