...
cor_results_read<-read.csv(paste0(outdir_s, 'cor_results.csv')) ## not sure try it 
...
###
merged_targets<-merge(all_targets_long_true, cor_results_long_symbol, by=c('mature_mirna_id', 'target_ensembl'))
...
mir_results_file_anticor=paste0(outdir_enrich, '/anticor/T_cor_', T_cor, 'dup', remove_dup_g )
