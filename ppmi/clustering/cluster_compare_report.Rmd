---
title: "Mofa Clusters Enrichment V06"
output:
...
source(paste0(script_dir, 'ppmi/clustering/run_clustering_pipeline.R'))
...
```{r emap_comp,   echo=FALSE, message=FALSE,fig.width=15,  fig.show='hold',out.width ="70%",  fig.cap="Pathway analysis Comparisons" ,fig.align='center' }
